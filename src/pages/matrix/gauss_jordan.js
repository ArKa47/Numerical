...
import gauss_jordan from '../../pictures/gauss_jordan.jpg'
...
function cramer ()
{
    ...
    {
        try{
            const data = await axios.get("https://my-json-server.typicode.com/ArKa47/api/matrix/gauss_jordan").then(response => response.data)
            console.log(data)
            let arr = data["Array"];
            //console.log(arr)
    ...
    return(
        <div className="App">
            ...
            <div className="container">
                <h1 className="title is-1" id="test">Gauss Jordan</h1>
                <h1 className="subtitle">Matrix</h1>
                <br></br>
                <img src={gauss_jordan} alt="gauss_jordan"/>
